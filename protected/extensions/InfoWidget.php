...
class InfoWidget extends CWidget {
    ...
    public function init() {
		...
		$this->content .= '<br/>';
		$this->content .= '<br/>';
		$this->content .= 'Durch Neuordnung einzelner Ressorts ist teilweise der';
		$this->content .= 'Vorjahresvergleich nicht möglich. Trotz sorgfältiger Prüfung kann für';
		$this->content .= 'Übertragungsfehler keine Haftung übernommen werden.';
		$this->content .= '<br/>';
		$this->content .= '<br/>';
